...
- LoopCheck Canary turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page app called LoopCheck Canary. It should show three compact status cards, a refresh button that updates a timestamp, and one toggle that changes a status label between Ready and Paused. Keep it simple and use the existing stack.
...
- Gameplay - LoopCheck Canary
- Game Settings - LoopCheck Canary

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - LoopCheck Canary
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - LoopCheck Canary
